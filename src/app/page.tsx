...
export default function HomePage() {
  return (
    <main className="min-h-screen">
      <h1 className="text-main-300 mx-auto max-h-[673px] bg-[url(/pink_blue_flowers.webp)] bg-fixed bg-top px-6 py-24 text-center text-5xl break-keep [-webkit-text-stroke:0.4px_white] xl:bg-cover">
